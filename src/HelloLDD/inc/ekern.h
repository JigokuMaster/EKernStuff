...
//	IMPORT_C static TInt AppendFormat(TDes8 &, char  const*, std::__va_list);
	IMPORT_C static TInt AppendFormat(TDes8 &, char  const*, ...);
...
//	IMPORT_C static TInt Printf(char  const*, ...);
	IMPORT_C static void Printf(char  const*, ...);
	...
	IMPORT_C static void Restart(int);
...
//	IMPORT_C static TInt SafeClose(DObject *&, void *);
	IMPORT_C static void SafeClose(DObject *&, void *);
